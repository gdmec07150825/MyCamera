    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBgList == null) {
            ...
            for (int i = 0; i <= mBgList.length - 1; i++) {
                flipper.addView(addImage(mBgList[i]), i, new ViewGroup.LayoutParams(ViewGroup
        ...
        sel = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                if (x > 10 && System.currentTimeMillis() > startTime + 1000) {
                    ...
                    flipper.setInAnimation(AnimationUtils.loadAnimation(AlbumActivity.this, R
                            .anim.push_right_in));
                    flipper.setOutAnimation(AnimationUtils.loadAnimation(AlbumActivity.this, R
                            .anim.push_right_out));
